...
public class FragmentAlert extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button close_fragment = view.findViewById(R.id.close_fragment);
        FrameLayout fragment_alert = view.findViewById(R.id.framelayout_alert);
        close_fragment.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                fragment_alert.setVisibility(fragment_alert.GONE);
            }
        });
        return view;
    }
